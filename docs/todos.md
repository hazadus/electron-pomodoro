...
- [ ] В уведомлении об окончании таймера (на MacOS) слева значок Электрон, справа – наш значок. Разместить наш значок `assets/images/pomodoro.png` вместо значка Электрона
