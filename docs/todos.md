...
- [ ] 🔧 Установить зависимости разработки (ESLint, Prettier, TypeScript, Husky, lint-staged)
- [ ] 🎵 Установить производственную зависимость `play-sound`
- [ ] ⚙️ Настроить ESLint конфигурацию с правилами для Electron и TypeScript
- [ ] 💅 Настроить Prettier для форматирования кода
- [ ] 🐶 Настроить Husky и lint-staged для pre-commit проверок
- [ ] 📝 Создать VS Code настройки для автоформатирования
...
### 📁 Структура проекта
- [ ] 📂 Создать директории согласно архитектуре (`types/`, `services/`, `windows/`, `utils/`)
- [ ] 🖼️ Добавить ресурсы (иконки для разных типов таймеров, звуковой файл)
- [ ] 📄 Настроить TypeScript конфигурацию с алиасами

## 🎯 Базовая архитектура

### 📝 Типы данных
- [ ] ⏰ Создать типы для таймеров (`types/timer.ts`)
- [ ] ⚙️ Создать типы для настроек (`types/settings.ts`)
- [ ] 📈 Создать типы для статистики (`types/stats.ts`)
