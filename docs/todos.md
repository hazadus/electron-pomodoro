...
- [x] 🎵 Добавить качественный звуковой файл уведомлений
- [x] 🌍 Проверить корректность русской локализации
...
- [x] 📦 Протестировать упаковку приложения
- [x] 📋 Проверить работу в чистой системе MacOS
- [x] 📋 Проверить работу в чистой системе Windows
...
- [x] 🔔 Уведомления работают с контекстными кнопками
- [x] 🎵 Звуковые уведомления настраиваемы
- [x] ⚙️ Все окна функционируют корректно
- [x] 🗑️ **Сброс статистики работает с подтверждением**
...
- [x] 📝 Добавить скриншот в `README.md`
- [ ] 📝 Создать `docs/architecture.md` с подробным описанием архитектуры приложения
- [ ] 📝 Добавить подробное описание структуры директорий проекта в `architecture.md`
...
- [x] При нажатии кнопки "Короткий перерыв" в уведомлении (MacOS) о завершении рабочего таймера, таймер перерыва не запускается
...
- [x] Разрешать запускать только один инстанс приложения одновременно
- [x] Написать скрипт для мониторинга логов приложения в реальном времени
- [x] В уведомлении об окончании таймера (на MacOS) слева значок Электрон, справа – наш значок. Разместить наш значок `assets/images/pomodoro.png` вместо значка Электрона
- [x] В окне "О программе" ссылки должны открываться в системном браузуре, а не в окнах Электрон как сейчас
- [x] Менять цвет иконки в трее (черный/белый), как у других приложений
- [x] Доработать иконку для трея, чтобы у неё было выше разрешения и она была больше похожа по паддингу на иконки других приложений
- [x] В окне "О программе" под номером версии указывать дату и время сборки приложения. Для этого "прошивать" время сборки при выполнении GitHub Action при выпуске релиза
