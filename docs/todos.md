...
- [ ] При изменении длительности таймера в настройках, в меню оно не меняется
- [ ] Статистика не сохраняется
- [ ] Уведомление по окончании таймера не отображается
- [ ] Сделать подходящие размеры окон, чтобы не было полос прокрутки

## Улучшения

- [ ] При работающем таймере скрывать иконку в трее (так как есть эмоджи и текст)
