...
Все операции с экземплярами приложения логируются:
- Успешное получение блокировки при запуске
- Завершение дублирующих экземпляров
- Попытки запуска второго экземпляра с параметрами командной строки и рабочей директорией
